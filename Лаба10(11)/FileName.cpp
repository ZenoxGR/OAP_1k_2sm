...
struct Tree {
	...
	int key;         //ключ
	char text[10];    //текст - не более 10 букв
	Tree* Left, * Right;
};
...
int countVertexes(Tree* t, int k); // основное задание: Написать функцию вывода количества вершин дерева
...
int countVertexes(Tree* t, int k) { // Написать функцию вывода количества вершин дерева, значение которых равно k.
